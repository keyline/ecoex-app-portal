<?php	
    ...
    $conditions         = ['ecoex_user_table.user_id' => $inventory->seller_id];
	              ...
	              <tr>	               
	               <td>	                  
	                  <table cellpadding="10" border="1" cellspacing="0" width="100%" style="border: 1px solid #ccc">
	                     ...
	                     <tr>
	                        <td>Month/Year</td>
	                        <td><?=$common_model->monthName($itemDetails->month)?> / <?=$itemDetails->year?></td>
	                     </tr>
	                     <tr>
	                     ...
	                     <tr>
                      	...
                      	<!-- <tr>
	                        ...
	                        <td>
	                        	<?php
	                        	$require_documents = json_decode($inventory->require_documents);
	                        	...
	                        	<table cellpadding="5" cellspacing="2">
	                        		...
	                        		if(count($require_documents)){ for($i=0;$i<count($require_documents);$i++){
	                        			...
	                        			$contn                  = [
                                            'inquiry_id'            => $inventory->id,
                                            'inventory_details_id'  => $inventory->inventory_details_id,
	                        		...
	                        		<tr>
	                        			...
	                        			<td>
	                        				<?php if($checkDocumentUpload){?>
	                                            <a href="<?=base_url('/writable/uploads/'.$checkDocumentUpload->inquiry_document)?>" target="_blank"><img src="<?=base_url('/writable/uploads/'.$checkDocumentUpload->inquiry_document)?>" style="height: 100px;width: 100px;" /></a>
	                                        <?php }?>
	                        			</td>
	                        		</tr>
	                        		<?php } }?>
