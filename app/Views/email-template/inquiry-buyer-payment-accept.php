             	...
             	<tr>
		            <td align="left" class="titleblock" style="padding:7px 0">
		               <font size="2" face="Open-sans, sans-serif" color="#222">
		                  <span class="title" style="font-weight:400;font-size:18px;line-height:33px"><strong>Dear</strong> <?=(($buyer)?$buyer->user_name:'')?></span>
		               </font>
		            </td>
	            </tr>
	            <tr>
		            <td align="left" class="titleblock" style="padding:7px 0">
		               <font size="2" face="Open-sans, sans-serif" color="#222">
		                  <span class="title" style="font-weight:bold;font-size:18px;line-height:33px;color: #48974e;">
		                  	Your Uploaded Payment Information Accepted By EcoEx Successfully !!!
		                  </span>
		               </font>
		            </td>
	            </tr>
	              <tr>	               
	               <td>	                  
	                  <table cellpadding="10" border="1" cellspacing="0" width="100%" style="border: 1px solid #ccc">
	                     ...
	                     <tr>
	                        <td>Ecoex Bank Details</td>
	                        <td>
	                        	<p><h4>Bank Name</h4> <?=$site_setting->bank_name?></p>
	                        	<p><h4>Bank Branch</h4> <?=$site_setting->bank_branch?></p>
	                        	<p><h4>Accoount Number</h4> <?=$site_setting->account_no?></p>
	                        	<p><h4>IFSC Code</h4> <?=$site_setting->ifsc_code?></p>
	                        </td>
	                     </tr>
	                  </table>
