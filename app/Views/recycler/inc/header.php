        ...
        <ul class="navbar-nav navbar-right align-items-center">          
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="<?=base_url('recycler/profile-settings')?>" class="dropdown-item has-icon">
                <i class="fa fa-user"></i> Profile Setting
              </a>
              <a href="<?=base_url('recycler/change-password')?>" class="dropdown-item has-icon">
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              <li class="nav-item <?php if($currentContorller == ''){ echo 'active'; } ?>">
                <a href="<?php echo base_url('recycler/');?>" class="nav-link"><i class="fa fa-fire"></i><span>Dashboard</span></a>
              </li>
              ...
              || $currentContorller == 'editInventory'){ echo 'active'; } ?>">
                <a href="<?php echo base_url('recycler/inventoryList');?>" class="nav-link"><i class="fa fa-chart-bar"></i><span>Inventory</span></a>
              </li>
              <!-- <li class="nav-item">
