                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">                                    
                                    ...
                                    <div class="toggle">
                                        <input type="radio" name="inventory_type" value="BUY" id="inventory_type1" <?=(($inventoryData->inventory_type == 'BUY')?'checked':'')?> required onclick="getMainCategory('BUY',<?=$user_member_type?>,'recycler/getMainCategory/');"/>
                                        <label for="inventory_type1">I Want To <b>BUY</b></label>
                                        <input type="radio" name="inventory_type" value="SELL" id="inventory_type2" <?=(($inventoryData->inventory_type == 'SELL')?'checked':'')?> required onclick="getMainCategory('SELL',<?=$user_member_type?>,'recycler/getMainCategory/');"/>
...
<script>
    $(document).ready(function(){ 
        ...
        let url             = 'recycler/getMainCategory/';
