          ...
          <div class="row align-items-center mt-3">
            ...
            <div class="col-md-6">
              <div class="market_tagettop_btn">
                <a href="/recycler/inventory/" class="nav-link greenbtn"> Add New</a>
    ...
    $allocatedQty = $getStateAllocateQty->allocateQty;
                    ...
                    ?>                  
                        <tr>
                          ...
                          </span> <span class="targe_table_pweight"><?php echo $inventory['qty'].''.$unit->name;?></span></div>	</td>
                          <td>Unallocated
                          ...
                          <td rowspan="2">
                            <div class="taget_table_button">
                              ...
                              <?php if(!$inventory['visibility']){?>
                                <a href="javascript:void(0);" data-id="<?=$inventory['inventory_id']?>" data-visibility="1" data-link="recycler/inventoryList" data-action="recycler/changeVisibility" class="btn btn-success visibility">Public</a>
                              <?php } else {?>
                                <a href="javascript:void(0);" data-id="<?=$inventory['inventory_id']?>" data-visibility="0" data-link="recycler/inventoryList" data-action="recycler/changeVisibility" class="btn btn-danger visibility">Private</a>
                              <?php }?>
                            </div>
                          </td>
                        </tr>
