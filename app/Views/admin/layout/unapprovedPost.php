                ...
                <div class="col-md-12">
                  <div class="box">
                    <div class="box-header">
                        <h3 class="box-title" style="float:left">Manage Pending Posts</h3>
                    </div>
                    <div class="col-md-12">
                            ...
                            <tbody>
                              <?php if($userData1){ $sl=1; foreach($userData1 as $row){?>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <a href="<?=base_url('/admin/postApprove/'.encoded($row->target_id).'/'.encoded(1))?>" class="btn btn-success" onclick="return confirm('Do You Want To Approve This Post ?');">Approve</a>
                                    <br><br>
                                    <a href="<?=base_url('/admin/postDetails/'.encoded($row->target_id).'/'.encoded(1))?>" class="btn btn-info">Details</a>
                                  </td>
                                </tr>
                              <?php } } else {?>
                                <tr>
                                  <td colspan="6" style="text-align: center;">No Brand Posts Found !!!</td>
                                </tr>
                              <?php }?>
                            </tbody>
                          </table>
                            ...
                            <tbody>
                              ...
                              <?php if($userData[$member_cat->member_id]){ $sl=1; foreach($userData[$member_cat->member_id] as $row){?>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <a href="<?=base_url('/admin/postApprove/'.encoded($row->inventory_id).'/'.encoded($member_cat->member_id))?>" class="btn btn-success" onclick="return confirm('Do You Want To Approve This Post ?');">Get Approve</a>
                                    <br><br>
                              ...
                              <?php } } else {?>
                                <tr>
                                  <td colspan="6" style="text-align: center;">No <?=$member_cat->member_type?> Posts Found !!!</td>
                                </tr>
                              <?php }?>
                            </tbody>
                          </table>
