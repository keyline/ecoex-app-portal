                ...
                <div class="col-md-12">
                  <div class="box">
                    <div class="box-header">
                        ...
                        <p><a class="btn btn-success" href="<?=base_url('admin/addStateList/')?>"><i class="nav-icon fas fa-plus"></i> Add State</a></p>
                    </div><!-- /.box-header -->
                    ...
                    <table id="example" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <a class="text-primary" href="<?=base_url('admin/updateStateList/'.$row->state_id)?>"><i class="nav-icon fas fa-edit"></i> Edit</a>
                              </td>
                            </tr>
                            <?php $i++; } }?>
                        </tbody>
