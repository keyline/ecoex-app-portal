              ...
              <div class="toptile_search">
                ...
                <div class="box-number-filter">
                   <div class="tablelist_number">
                   		<h3>Total: <?php echo $totalPendingSum;?> Pending Members</h3>
                   </div>
                ...
                <tr>
                  ...
                  <td>
                    <a target="_blank" href="<?php echo site_url('admin/memberDetail/'.encoded($row['c_id']));?>" class="btn btn-outline-success">Details</a><br><br>
