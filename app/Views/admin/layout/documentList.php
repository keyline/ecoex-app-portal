                  ...
                  <div class="col-md-12">
                    <div class="box">
                      <div class="box-header">
                          ...
                          <p><a class="btn btn-success" href="<?=base_url('admin/addDocumentList/')?>"><i class="nav-icon fas fa-plus"></i> Add Document</a></p>
                      </div><!-- /.box-header -->
                      ...
                      <table id="example" class="table table-bordered table-striped">
                          ...
                          <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <a class="text-primary" href="<?=base_url('admin/updateDocumentList/'.$row->id)?>"><i class="nav-icon fas fa-edit"></i> Edit</a>
                                </td>
                              </tr>
                              <?php $i++; } }?>
                          </tbody>
