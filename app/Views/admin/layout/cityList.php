              ...
              <div class="col-md-12">
                <div class="box">
                  <div class="box-header">
                      ...
                      <p><a class="btn btn-success" href="<?=base_url('admin/addCityList/')?>"><i class="nav-icon fas fa-plus"></i> Add City</a></p>
                  </div><!-- /.box-header -->
                  ...
                  <table id="example" class="table table-bordered table-striped">
                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <?php
                              $district = $common_model->find_data('ecoex_district', 'row', ['districtid' => $row->districtid]);
                              if($state){
                                echo $district->district_title;
                              }
                              ?>
                            </td>
                            <td><?=$row->name?></td>
                            <td>
                              <a class="text-primary" href="<?=base_url('admin/updateCityList/'.$row->id)?>"><i class="nav-icon fas fa-edit"></i> Edit</a>
                            </td>
                          </tr>
                          <?php $i++; } }?>
                      </tbody>
