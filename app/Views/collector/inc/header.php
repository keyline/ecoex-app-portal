    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar clientdash-navbar">
        ...
        <ul class="navbar-nav navbar-right align-items-center">          
          ...
          <li class="dropdown dropdown-list-toggle">
            <h5><a href="<?=base_url()?>" target="_blank" class="nav-link notification-toggle nav-link-lg beep" style="color: var(--primariygreen);">Visit Marketplace</a></h5>
          </li>
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <div class="d-sm-none d-lg-inline-block">Hi, <?php echo $userData->user_name;?></div></a>
            <div class="dropdown-menu dropdown-menu-right">
              <!-- <div class="dropdown-title">Logged in 5 min ago</div> -->
              <a href="<?=base_url('collector/profile-settings')?>" class="dropdown-item has-icon">
                <i class="fa fa-user"></i> Profile Setting
              </a>
              <a href="<?=base_url('collector/change-password')?>" class="dropdown-item has-icon">
              ...
              <a href="<?php echo base_url('collector/logout');?>" class="dropdown-item has-icon text-danger">
      ...
      <div class="main-sidebar clientdash_mainsidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand pt-3 mb-3">
            <a href="#"><img src="<?php echo site_url('public');?>/assets/client//images/logo.svg" alt="Logo"></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm pt-2 mb-5">
            <a href="#"><img src="<?php echo site_url('public');?>/assets/client/images/logo-icon.png" alt="Logo"></a>
          </div>
          <ul class="sidebar-menu">
              <li class="nav-item <?php if($currentContorller == ''){ echo 'active'; } ?>">
                <a href="<?php echo base_url('collector/');?>" class="nav-link"><i class="fa fa-fire"></i><span>Dashboard</span></a>
              </li>
              <li class="nav-item <?php if($currentContorller == 'inventoryList' || $currentContorller == 'inventory' || $currentContorller == 'addInventoryByState'
              || $currentContorller == 'editInventory'){ echo 'active'; } ?>">
                <a href="<?php echo base_url('collector/inventoryList');?>" class="nav-link"><i class="fa fa-chart-bar"></i><span>Inventory</span></a>
              </li>
              <!-- <li class="nav-item">
                <a href="#" class="nav-link"><i class="fa fa-th-large"></i><span>Manage Quotes</span></a>
              </li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa fa-store-alt"></i> <span>Marketplace</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="#">Plastic</a></li>
                  <li><a class="nav-link" href="#">E-Waste</a></li>
                  <li><a class="nav-link" href="#">Rubber</a></li>
                </ul>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link"><i class="fa fa-question"></i><span>Manage Inquiries</span></a>
              </li>
               <li class="nav-item">
                <a href="#" class="nav-link"><i class="fa fa-sort-amount-up"></i><span>Manage Orders</span></a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link"><i class="fa fa-layer-group"></i><span>Manage Inventory</span></a>
              </li>
               <li class="nav-item">
                <a href="#" class="nav-link"><i class="fa fa-users"></i><span>Manage Team</span></a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link"><i class="fa fa-building"></i><span>Company Details</span></a>
              </li>
              <li class="nav-item">
