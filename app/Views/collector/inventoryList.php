          ...
          <div class="row align-items-center mt-3">
            <div class="col-md-4">
              <!-- <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                  <a class="greenbtn nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">
                    Plastic
                  </a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="greenbtn nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">E-Waste</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="greenbtn nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Rubber</a>
                </li>
              </ul> -->
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-6">
              <div class="market_tagettop_btn">
                <a href="/collector/inventory/" class="nav-link greenbtn"> Add New</a>
                              ...
                              <tbody>            
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <?php echo $stateName->state_title;?> / <?php echo $stateTarget['req_qty'].''.$unit->name;?><br>
                                  ...
                                  <td>                          
                                    ...
                                    $unallocateQty = $stateTarget['req_qty'];
                                    ?>
                                    <?php echo $unallocateQty.''.$unit->name;?></br>
                                    <?php } ?>    
                                  </td>
                                  <td>                          
                                    <?php 
                                    ...
                                    foreach($stateAllocateData as $stateTarget){                                      
                                    ?>
                                      <?php echo ucwords($stateTarget['storeLocation']);?></br>
                                    <?php } ?>    
                                  </td>
                                  <td>
                                    <div class="taget_table_button">
                                      <!-- <a href="#!" class="greenbtn">Order Details</a> -->
                                      <a href="setInventoryId/<?php echo $inventory['inventory_id'];?>" class="filter_btn">Edit</a>
                                      <?php if(!$inventory['visibility']){?>
                                        <a href="javascript:void(0);" data-id="<?=$inventory['inventory_id']?>" data-visibility="1" data-link="collector/inventoryList" data-action="collector/changeVisibility" class="btn btn-success visibility">Public</a>
                                      <?php } else {?>
                                        <a href="javascript:void(0);" data-id="<?=$inventory['inventory_id']?>" data-visibility="0" data-link="collector/inventoryList" data-action="collector/changeVisibility" class="btn btn-danger visibility">Private</a>
                                      <?php }?>
                                    </div>
                                  </td>
                                </tr>
