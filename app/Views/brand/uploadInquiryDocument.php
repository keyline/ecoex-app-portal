                    ...
                    <div class="toptile_search">
                        ...
                        <?php if($row->published == 2){?>
                            <?php if($row->po_documents == '' && $userId == $row->buyer_id){?>
                                <a href="<?=base_url('brand/inquiryAcceptDocument/'.encoded($row->id))?>" class="btn btn-success" onclick="return confirm('Are You Sure ?');"><i class="fa fa-check"></i> Accept Inquiry Documents</a>
                            <?php }?>
                        <?php }?>
                    </div>
                </div>
                                        ...
                                        <div class="card-body">
                                            <?php if($row->po_documents == ''){?>
                                                <?php if($userId == $row->buyer_id) {?>
                                                    <form method="post" action="<?=base_url('/brand/uploadPO/'.encoded($row->id))?>" enctype="multipart/form-data">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="file" class="form-control" name="po_documents" id="po_documents" accept="image/gif, image/jpeg, image/png, application/pdf" required>
                                                            </div>
                                                            <div class="col-md-6">
