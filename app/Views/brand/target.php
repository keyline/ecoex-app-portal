            ...
            <div class="col-md-12">
              <div class="dashboard_white_panel mt-3">
                ...
                <div class="d-flex justify-content-between pt-3 pb-3 pl-3 pr-3 align-items-center">
                  <form role="form" id="addUser" action="addTargetData" method="post" >
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">                                    
                                    ...
                                    <div class="toggle">
                                        <input type="radio" name="inventory_type" value="BUY" id="inventory_type1" onclick="getMainCategory('BUY',<?=$user_member_type?>,'brand/getMainCategory/');" required/>
                                        <label for="inventory_type1">I Want To <b>BUY</b></label>
                                        <input type="radio" name="inventory_type" value="SELL" id="inventory_type2" onclick="getMainCategory('SELL',<?=$user_member_type?>,'brand/getMainCategory/');" required/>
                        ...
                        <div class="box-footer">
                            <input type="submit" id="submit-btn" class="btn btn-primary" name="submit" value="Add Target">
                        </div>
                    </form>
                </div>
              </div>
