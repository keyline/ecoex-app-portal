    ...
    <div class="rightdash_img">
        <div class="rightsection_form loginfrom_center">
            ...
            <div class="form_section">
                <form method="post" action="<?php echo site_url('otpVerification/'.$companyID) ?>">
                    <input type="hidden" class="form-control" id="c_id" name="c_id" value="<?php echo $companyID; ?>" >
                    ...
                    <div class="form-group">
                        <a class="text-left" href="<?php echo base_url('skipMobileOTP/'.$companyID) ?>" style="font-size: 20px;color: #48974e;float: left;">Skip For Now</a>
                    </div>
                    <div class="form-group" id="resendOTP" style="display:none;">
                        <a class="text-right pt-3" href="<?php echo site_url('resendOTP/'.$companyID) ?>" style="font-size: 20px;color: #48974e;float: right;">Resend code</a>
                    </div>
                </form>
            </div>
        </div>
