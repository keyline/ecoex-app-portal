        ...
        <ul class="navbar-nav navbar-right align-items-center">          
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="<?=base_url('user/profile-settings')?>" class="dropdown-item has-icon">
                <i class="fa fa-user"></i> Profile Setting
              </a>
              <a href="<?=base_url('user/change-password')?>" class="dropdown-item has-icon">
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              <li class="nav-item <?php if($currentContorller == ''){ echo 'active'; } ?>">
                <a href="<?php echo base_url('user/');?>" class="nav-link"><i class="fa fa-fire"></i><span>Dashboard</span></a>
              </li>
              <?php if($userData){ if(($userData->user_email_auth)){?>
                <li class="nav-item <?php if($currentContorller == 'inventoryList' || $currentContorller == 'inventory' || $currentContorller == 'addInventoryByState' || $currentContorller == 'editInventory'){ echo 'active'; } ?>">
                  <a href="<?php echo base_url('user/inventoryList');?>" class="nav-link"><i class="fa fa-chart-bar"></i><span>Post Inventory</span></a>
                </li>
                <li class="nav-item <?php if($currentContorller == 'inquiryList' || $currentContorller == 'editInquiry'){ echo 'active'; } ?>">
                  <a href="<?php echo base_url('user/inquiryList');?>" class="nav-link"><i class="fa fa-question"></i><span>Manage Inquiries</span></a>
                </li>
              <?php } }?>
              <!-- <li class="nav-item">
