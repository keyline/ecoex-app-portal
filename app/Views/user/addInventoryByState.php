                        ...
                        <div class="box-body"> 
                            ...
                            <div class="row">  
                                ...
                                <div class="col-md-3">                                
                                    ...
                                    <?php } ?>    
                                        <input type="number" class="form-control required stateQty" name="qty[]" value="<?php echo $insertState['req_qty'];?>" required required min="1" onkeypress="return isNumber(event)">
                                    </div>
                                </div>
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                    <?php if($i==1){?>    
                                        <label for="fname">Rate Per MT *</label>
                                    <?php } ?>    
                                        <input type="number" class="form-control required" name="rate[]" value="<?php echo $insertState['rate'];?>" step="0.1" required>
                                    </div>
                                </div>
                        </div>
                            <?php $i++; } ?>
                            ...
                            <div class="row" <?php if($j!=$i){?> style="display:none;" <?php } ?> id="inventoryFormDiv<?php echo $j;?>">  
                                ...
                                <div class="col-md-3">                                
                                    ...
                                    <?php } ?>    
                                        <input type="text" class="form-control required" name="rate[]" value="0" step="0.1">
                                    </div>
                                </div>
                                <div class="col-md-1">                                
                                    <div class="form-group">
