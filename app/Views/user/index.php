                      ...
                      <div class="collapse multi-collapse" id="multiCollapseExample1">
                        <!-- <form method="post" action=""> -->
                          ...
                          <div class="form-group">
                            <input type="number" id="userotp" class="form-control" placeholder="Enter OTP" maxlength="6" minlength="6">
                          </div>
            ...
            <div class="col-lg-12">
              <div class="dashboard_white_panel mt-3">
                <div class="d-flex justify-content-between pt-3 pb-3 pl-3 pr-3 align-items-center">
                  ...
                  <div class="dashbar_linkbtb">
                    <a href="<?=base_url('user/inventory')?>"><img src="<?php echo site_url('public');?>/assets/client/images/create_icon.png" alt="" class="pr-2"> Create</a>
                  </div>
                </div>
              </div>
            </div>
