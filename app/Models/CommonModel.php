...
class CommonModel extends Model
{
    ...
    function upload_single_file($fieldName,$fileName,$uploadedpath='',$uploadType)
    {
        ...
        else
        {
            ...
            if($uploadedpath=='') {
                ...
                $upload_path = 'writable/uploads/'.$uploadedpath.'/';
            }
    ...
    {
        $siteSetting    = $this->find_data('ecoex_setting', 'row');
        $email = \Config\Services::email();        
    ...
    function getUserByUserId($id){
        ...
        $select                 = 'ecoex_user_table.*,ecoex_company.c_name,ecoex_member_category.member_type,ecoex_member_category.short_name';
        $user                   = $this->find_data('ecoex_user_table', 'row', $condition, $select, $join, $select, $orderBy);
        return $user;
    }
