<?php
namespace App\Controllers\Recycler; // Controller namespace
...
class DashboardController extends BaseController
{
	...
	{ 
        ...
        if(isset($userId)){
          ...
          $data['contoroller'] = $dashboard;
            ...
            return view('recycler/index',$data);
        } else {
            return redirect()->to(base_url('login'));
        }
	}
	...
	{ 
        ...
        if(isset($userId)){
          ...
          $data['contoroller'] = $dashboard;
            ...
            return view('recycler/inventory',$data);
        } else {
            return redirect()->to(base_url('login'));
        }
	}
	...
	{ 
        ...
        if(isset($userId)){
          ...
          $uploadedAttachment = '';
            ...
            return redirect()->to(base_url('recycler/addInventoryByState'));
        } else {
            return redirect()->to(base_url('login'));
        }
	}
	...
	{ 
        ...
        if(isset($userId)){
          ...
          $data['unitData'] = $unitData;
          $data['contoroller'] = $dashboard;
            return view('recycler/addInventoryByState',$data);
        } else {
            return redirect()->to(base_url('login'));
        }
	}
	...
	{ 
        ...
        if(isset($userId)){
          ...
          $lastInsrtInventoryStatID = $dashboard->addInventoryByStateData($data);
            ...
            return redirect()->to(base_url('recycler/inventoryList'));
        } else {
            return redirect()->to(base_url('login'));
        }
	}
	...
	{ 
        ...
        if(isset($userId)){
          ...
          $data['contoroller'] = $dashboard;
            ...
            return view('recycler/inventoryList',$data);
        } else {
            return redirect()->to(base_url('login'));
        }
	}
	...
	{ 
        ...
        return redirect()->to(base_url('recycler/editInventory'));
	}
	...
	{ 
        ...
        if(isset($userId)){
          ...
          $data['contoroller'] = $dashboard;
            ...
            return view('recycler/editInventory',$data);
        } else {
            return redirect()->to(base_url('login'));
        }
	}
    ...
    public function changePassword()
    {
        ...
        if(isset($userId)){            
            ...
            $data['userId']         = $userId;          
            return view('recycler/change-password',$data);
        } else {
            return redirect()->to(base_url('login'));
        }
    }
	...
	public function profileSettings()
    {
        ...
        if(isset($userId)){            
            ...
            $data['storeId']        = $storeId;          
            $data['userId']         = $userId;          
            return view('recycler/profile-settings',$data);
        } else {
            return redirect()->to(base_url('login'));
        }
    }
